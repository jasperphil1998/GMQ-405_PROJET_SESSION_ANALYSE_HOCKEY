...
message("\n=== 10 — CLASSIFICATION SPATIALE (ClustGeo) ===")

if (!requireNamespace("ClustGeo", quietly = TRUE)) {
  # Voir la note dans 09_stkde.R : run_all.R lit MODULE_IGNORE pour ne pas
  # afficher "ok" sur un module qui n'a rien produit.
  MODULE_IGNORE <- TRUE
  message("Module 10 IGNORÉ : le paquet ClustGeo n'est pas installé.\n",
...
jrn <- journal_resultats("10_resultats_clustgeo.txt")
jrn$ecrire("=====================================================")
jrn$ecrire(" ANALYSE SPATIALE — 10. CLASSIFICATION SPATIALE")
...
sauver_graphique(graph_alpha, "10_graph_choix_alpha.png",
                 largeur = 9, hauteur = 6)
...
sauver_tableau(profils, "10_table_profils_classes.csv")
...
sauver_carte(carte_clustgeo, "10_carte_clustgeo.png")
...
sauver_carte(carte_comparaison_clustgeo, "10_carte_comparaison_contrainte.png",
