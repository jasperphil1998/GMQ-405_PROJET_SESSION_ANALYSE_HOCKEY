# =============================================================================
# 01_normalisation.R — Taux de production et quotient de localisation
# =============================================================================
# PROBLEME ADRESSE
# Le script principal cartographie des EFFECTIFS BRUTS (nombre de joueurs,
...
jrn    <- journal_resultats("01_resultats_normalisation.txt")

jrn$ecrire("=====================================================")
jrn$ecrire(" ANALYSE SPATIALE — 01. NORMALISATION")
...
# Recodage identique au script principal pour la jointure au fond de carte
joueurs_pays <- hockey %>%
  mutate(
...
sauver_tableau(table_pays_norm, "01_table_pays_normalise.csv")
...
sauver_carte(carte_taux_pays, "01_carte_taux_pays.png")
...
sauver_carte(carte_ql_pays, "01_carte_ql_pays.png")
...
population <- read_csv(
  chemin_as("data", "population_provinces_etats.csv"),
...
sauver_tableau(table_unites_norm, "01_table_provinces_etats_normalise.csv")
...
# Sauvegarde de l'objet spatial pour reutilisation par 02 et 05.
# Evite de refaire toute la preparation dans chaque script.
saveRDS(unites, chemin_sortie("unites_normalisees.rds"))
message("  -> unites_normalisees.rds (reutilise par 02 et 05)")
...
sauver_carte(carte_taux_unites, "01_carte_taux_provinces_etats.png")
...
sauver_carte(carte_comparaison, "01_carte_comparaison_brut_taux.png",
...
sauver_graphique(graph_deplacement, "01_graph_deplacement_rang.png",
                 largeur = 9, hauteur = 7)
