# =============================================================================
# 05_modelisation.R — Modelisation spatiale (OLS, SAR/SEM, GWR)
# =============================================================================
# PROBLEME ADRESSE
# Les modules 01 a 04 DECRIVENT la geographie du hockey. Ce module cherche a
...
message("\n=== 05 — MODELISATION SPATIALE ===")

jrn <- journal_resultats("05_resultats_modelisation.txt")
jrn$ecrire("=====================================================")
jrn$ecrire(" ANALYSE SPATIALE — 05. MODELISATION SPATIALE")
jrn$ecrire("=====================================================")

fichier_unites <- chemin_sortie("unites_normalisees.rds")
if (!file.exists(fichier_unites)) {
  stop("Lancer d'abord 01_normalisation.R.", call. = FALSE)
}
...
equipes <- read_csv(chemin_as("data", "equipes_lnh.csv"), show_col_types = FALSE) %>%
...
# =============================================================================
# Meme choix que dans le module 02 (k plus proches voisins), pour que les
...
jrn$ecrire("Matrice de voisinage : k = ", K_RETENU,
           " plus proches voisins (identique au module 02)")
...
sauver_tableau(comparaison, "05_table_comparaison_modeles.csv")
...
sauver_tableau(coefficients_tous, "05_table_coefficients.csv")
...
sauver_carte(carte_residus, "05_carte_residus.png", largeur = 14, hauteur = 6)
...
sauver_graphique(graph_coefficients, "05_graph_coefficients.png",
                 largeur = 9, hauteur = 6)
...
if (requireNamespace("MASS", quietly = TRUE)) {
  ...
  sauver_tableau(accord, "05_table_robustesse_signes.csv")
