...
- **B. Littérature méthodologique** — la source à citer pour chaque méthode
  employée dans `analyse_spatiale/`. Sert à justifier les choix techniques.
...
directement pourquoi la Saskatchewan devance l'Ontario dans notre module 01.
...
grappes régionales (LISA, module 02) plutôt qu'à un simple effet démographique.
...
population** — donc la même démarche que notre module 01, à une échelle plus
...
→ **Directement pertinent pour le module 04 (centrographie temporelle) et le
module 05 (latitude comme proxy du climat).** Traite du déplacement dans le
...
### B.1 — Module 01 : normalisation, taux et quotient de localisation
...
### B.2 — Module 02 : autocorrélation spatiale
...
### B.3 — Module 03 : semis de points, densité de noyau et risque relatif
...
### B.5 — Module 05 : modélisation spatiale
